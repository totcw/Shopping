...
public class TwoToolBarView extends RelativeLayout {
    ...
    public TwoToolBarView(Context context, AttributeSet attrs) {
        ...
        //设置图片
        mfiv_fist.setIvBackground(R.mipmap.filter_tab_under_icon,R.mipmap.filter_tab_under_icon);
        mfiv_second.setIvBackground(R.mipmap.filter_tab_under_icon,R.mipmap.filter_tab_under_icon);
         //设置文字颜色
        mfiv_fist.setLineBackground(getResources().getColor(R.color.activityMainPressed), getResources().getColor(R.color.activityMainPressed));
        mfiv_second.setLineBackground(getResources().getColor(R.color.activityMainPressed), getResources().getColor(R.color.activityMainPressed));
