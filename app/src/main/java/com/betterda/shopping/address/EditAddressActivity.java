...
import com.betterda.shopping.address.contract.EditAddressContract;
import com.betterda.shopping.address.presenter.EditAddressPresenterImpl;
...
public class EditAddressActivity extends BaseActivity<EditAddressContract.Presenter> implements EditAddressContract.View {
    ...
    RelativeLayout mRelativeChoseconstanct;
    ...
    ToggleButton mTbtnAddaddress;
    @BindView(R.id.btn_address_moren)
    Button mBtnAddressMoren;
    private StringBuilder stringBuilder;

    @Override
    protected EditAddressContract.Presenter onLoadPresenter() {
    ...
    public void init() {
        super.init();
        mTopbarAddaddress.setTitle("编辑收货地址");
        mTopbarAddaddress.setBusVisibility(true);
    }

    @Override
    public void initListener() {
        super.initListener();
        mTbtnAddaddress.setOnToggleChanged(new ToggleButton.OnToggleChanged() {
            @Override
    ...
    @OnClick({R.id.relative_addaddress_choseconstanct, R.id.relative_addaddress_province, R.id.btn_address_moren,R.id.bar_relative_bus,R.id.bar_back})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.relative_addaddress_choseconstanct:
